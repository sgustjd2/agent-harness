...
CODES = {
    ...
    "POLICY_INVOCATION_UNDECLARED",
    "POLICY_GRANT_NOT_PERMITTED",
    # implemented production Skills (M2)
    "SKILL_POLICY_MARKER_MISSING",
    "SKILL_POLICY_MARKER_MALFORMED",
    "SKILL_MUTATION_NOT_PERMITTED",
    "SKILL_COMMAND_BLOCK_PRESENT",
    "SKILL_VERIFICATION_DEFAULT_INVALID",
    "SKILL_REFERENCE_MISSING",
    "SKILL_EXECUTABLE_DIR_PRESENT",
    "SKILL_RUNTIME_DEPENDENCY",
    "SKILL_PROFILE_UNDECLARED",
    "SKILL_WRITE_ROOTS_MISSING",
    "SKILL_WRITE_ROOTS_UNEXPECTED",
    "SKILL_WRITE_ROOT_FORBIDDEN",
